...
public class compression {
	...
	public static void Gamma(int[] input,byte[] output,int[] number){
		...
		System.out.println("Gamma编码BPI："+BPI+"  bits per integer");
		BitUtils.pos=0;
		BitUtils.outpos=0;
		BitUtils.inpos = 0;
	...
	public static void Delta(int[] input,byte[] output,int[] number){
		...
		double BPI = (double)8*BitUtils.outpos/Datatest.amount;
		System.out.println("Delta编码BPI："+BPI+"  bits per integer");
		BitUtils.pos=0;
		BitUtils.outpos=0;
		BitUtils.inpos = 0;
		while(BitUtils.outpos < output.length){
	...
	public static void Golomb(int[] input,byte[] output,int[] number,int m){
		...
		double BPI = (double)8*BitUtils.outpos/Datatest.amount;
		System.out.println("Golomb编码BPI："+BPI+"  bits per integer");
		//解码
		int n = output[0];
	...
	public static void Rice(int[] input,byte[] output,int[] number,int m){
		...
		double BPI = (double)8*BitUtils.outpos/Datatest.amount;
		System.out.println("Rice编码BPI："+BPI+"  bits per integer");
		//解码
		int n = output[0];
		int amount_length = output[1];
		BitUtils.pos=0;
	...
	public static void Interpolative(int[] input,byte[] output,int[] number){
		...
		double BPI = (double)8*BitUtils.outpos/Datatest.amount;
		System.out.println("Interpolative编码BPI："+BPI+"  bits per integer");
		//解码
